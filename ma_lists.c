 ...
 * Return: size of list
 */
list_t *incrs_end_noods(list_t **head, const char *str, int num)
{
 ...
 * Return: size of list
 */
size_t string_list_printer(const list_t *h)
{
	size_t i = 0;
...
/**
 * index_noods_deleter - deletes node at given index
 * @head: address of pointer to first node
 * @index: index of node to delete
 *
 * Return: 1 on success, 0 on failure
 */
int index_noods_deleter(list_t **head, unsigned int index)
{
